...
- Remaining: consented patient transfers — the user decided on a **shared registry** model (both clinics see the same linked patient record) — schema and implementation work not yet started.
