...
| `09-integrations-api.md` | Partner API, webhooks, calendar/accounting export | 🔵 Active — webhook delivery now real |
| `10-offline-mode.md` | Secure, minimal offline clinical access (threat-modeled) | ⛔ Blocked |
| `11-platform-operations.md` | Support tooling, tenant export, retention, security alerts | 🔵 Active — export generation now real |
