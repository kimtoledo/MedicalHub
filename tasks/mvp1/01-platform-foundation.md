...
> **Status:** 📋 Draft — covered by project tasks #6, #7, #8, #13
...
3. **Configure Better Auth** — install and configure Better Auth on the API; define the `superAdmin` and `clinicMember` session strategies (#8).
