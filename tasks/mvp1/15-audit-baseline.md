...
The Super Admin audit log page (`/th-admin/audit`) shows a paginated, filterable list of all platform-level events with actor, action, and timestamp.
...
3. **Admin audit page** — wire `/th-admin/audit` to `GET /v1/admin/audit` with date range, action type, and actor filters.
