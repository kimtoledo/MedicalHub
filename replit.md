...
| `remote-assessments.ts` | `remote_assessments`, `remote_assessment_photos` |
...
| `0004_billing_lite` | `price_php` on `services`; `invoices`, `invoice_line_items`, `invoice_payments` |
| `0005_prescriptions` | `prescriptions`, `prescription_items` |
| `0006_clinical_files` | `clinical_files` (Object Storage metadata) |
| `0007_ai_interactions` | `ai_interactions` |
| `0008_remote_assessments` | `remote_assessments`, `remote_assessment_photos` |
| `0009_hmo_claims` | `hmo_payers`, `patient_hmo_memberships`, `hmo_claims`; HMO columns on `services` |
