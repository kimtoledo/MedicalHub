...
import { CalendarDays, FileText, HeartPulse, Link2, Loader2, LogIn, LogOut, ShieldCheck, UserRound } from 'lucide-react';
...
type Tab = 'home' | 'appointments' | 'billing' | 'plans' | 'profile';
...
export default function PatientPortalPage() {
  ...
  const tabs: Array<{ id: Tab; label: string; icon: typeof CalendarDays }> = [
    { id: 'home', label: 'Home', icon: HeartPulse }, { id: 'appointments', label: 'Visits', icon: CalendarDays }, { id: 'billing', label: 'Billing', icon: FileText }, { id: 'plans', label: 'Plans', icon: ShieldCheck }, { id: 'profile', label: 'Profile', icon: UserRound },
  ];
