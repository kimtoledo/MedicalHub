        ...
        <article key={item.id} className="flex flex-col gap-3 py-4 sm:flex-row sm:items-center">
          ...
          <div className="flex items-center gap-3 pl-12 sm:pl-0">
            ...
            <Link
              ...
              className="rounded-lg bg-violet-600 px-3 py-2 text-xs font-semibold text-white hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-violet-500"
            >
              View / Print
            </Link>
          </div>
