...
import { clinicFeatureOverrides, clinics, clinicSubscriptions, packageFeatures, packages } from '@dentra/db/schema';
...
export type ClinicEntitlements = {
  ...
  entitlements: Array<{ featureKey: FeatureKey; isEnabled: boolean; source: 'package' | 'override' | 'unavailable'; expiresAt: Date | null }>;
};
