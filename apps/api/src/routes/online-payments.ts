...
export async function registerOnlinePaymentRoutes(app: FastifyInstance, options: { auth: AuthServices; entitlements: EntitlementService; db?: import('@dentra/db').DB; payments: PaymentService }) {
