...
export async function registerAiImagingRoutes(app: FastifyInstance, options: { auth: AuthServices; entitlements: EntitlementService; db?: import('@dentra/db').DB; imaging: AiImagingService }) {
