...
function entitlements(enabled = true): EntitlementService { return { resolve: vi.fn(async () => ({ clinic: { id: CLINIC_ID, name: 'Clinic', status: 'active', maintenanceMode: false }, subscription: null, entitlements: [{ featureKey: FeatureKey.REPORTS_ADVANCED, isEnabled: enabled, source: 'override' as const, expiresAt: null }] })) }; }
