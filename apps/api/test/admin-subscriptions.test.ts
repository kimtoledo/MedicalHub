...
const service = (): AdminSubscriptionListService => ({ list: vi.fn(async () => ({ items: [{ id: 'sub', clinicId: 'clinic', clinicName: 'Smile Bright', clinicSlug: 'smile-bright', packageId: 'pkg', packageName: 'Professional', packageSlug: 'professional', status: 'active' as const, startsAt: new Date('2026-01-01'), expiresAt: null, createdAt: new Date('2026-01-01') }], packageOptions: [{ id: 'pkg', name: 'Professional' }], pagination: { page: 1, pageSize: 10, total: 1, totalPages: 1 } })) });
