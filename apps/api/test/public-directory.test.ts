...
function directory(): PublicDirectoryService { return {
  listClinics: vi.fn(async () => ({ items: [{ id: 'clinic', name: 'Smile Bright', slug: 'smile-bright', description: 'Public profile', logoUrl: null, city: 'Makati', province: 'Metro Manila', verificationStatus: 'verified', locations: ['Makati, Metro Manila'], services: ['Cleaning'] }], pagination: { page: 1, pageSize: 12, total: 1, totalPages: 1 } })),
