...
function entitlements(): EntitlementService { return { resolve: vi.fn(async (clinicId) => ({ clinic: { id: clinicId, name: 'Clinic', status: 'active' }, subscription: null, entitlements: [{ featureKey: FeatureKey.REPORTS_BASIC, isEnabled: true, source: 'override' as const, expiresAt: null }] })) }; }
